  ...
  class GreenhouseAdapter {
    ...
    getApplyButton(doc = window.document) {
      if (typeof safeFindApplyButton === "function") {
        return safeFindApplyButton(doc, ["#submit_app", "input[type='submit']", "button[type='submit']"]);
      }
      return typeof safeQuerySelector === "function" ? safeQuerySelector(doc, "#submit_app, input[type='submit'], button[type='submit']") : null;
    }
